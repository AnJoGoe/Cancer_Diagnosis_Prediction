...
def main():
    ...
    if df is not None:
        ...
        with st.expander("Feature Selection Results"):
            ...
            st.write("""
                The table shows the filtered data columns.
            """)
        ...
        with st.expander("Model Selection"):
            ...
            st.write("""
                Select Models from the dropdown menu. Combine multiple models. In case multiple models are selected the result will be the mode of the models. In case of a tie, the value of the first selected model contributing to the tie will be regarded.
            """)

            options = st.multiselect(
                '',
                ['Logistic Regression', 'Random Forest', 'AdaBoost(RF)', 'SVM'],
                ['AdaBoost(RF)']
            )
